// Global Settings
// ===============
var enabledGroupServices = true; 
var welcomeScreen = "<div class=\"UiWindowField scroller\"><pre style=\"font-size: 12px\"> </div>";
...
var userAgentStr = getDbItem("UserAgentStr", "Asterisk Phone");   
...
var videoHeight = getDbItem("VideoHeight", "");                         // Suggests a video height to your webcam.
var videoAspectRatio = getDbItem("AspectRatio", "");                    // Suggests an aspect ratio  to your webcam.
...
var DisplayDateFormat = getDbItem("DateFormat", "YYYY-MM-DD");  // The display format for all dates. 
var DisplayTimeFormat = getDbItem("TimeFormat", "h:mm:ss A");    // The display format for all times. 
var Language = getDbItem("Language", "auto");    // Overrides the langauage selector or "automatic". 
        ...
        navigator.mediaDevices.enumerateDevices().then(function(deviceInfos){
            ...
            navigator.mediaDevices.getUserMedia(contraints).then(function(mediaStream){
                ...
                if(VideoFound && videoTrack != null){
                    ...
                    console.warn("No video devices found. Video Calling not be possible.")
                }
...
function AddLineHtml(lineObj){
    ...
    html += "</td></tr>";
    html += "<tr><td class=\"streamSection streamSectionBackground\" style=\"background-image:url('"+ hostingPrefex +"images.jpeg')\">";
